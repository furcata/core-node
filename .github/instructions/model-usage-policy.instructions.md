...
- For tasks in repositories under stainlessai and colchis, the orchestrator must enforce a daily cap of:
    - Maximum 10 hours/day of estimated human work executed
- This cap is shared across both organizations because they belong to the same client.
...
- Required reporting (for stainlessai/colchis daily summary):
